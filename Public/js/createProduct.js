const createProduct = (data) => {
    ...
    <div class="product-card">
        <div class="product-image">
            ...
            <img src="${data.images[0] || 'img/no image.png'}" class="prdouct-thumb" alt="">
            <button class="card-action-btn edit-btn" onclick="location.href = '/add-product/${data.id}'"><img src="img/edit.png" alt=""></button>
            <button class="card-action-btn open-btn" onclick="location.href = '/product/${data.id}'"><img src="img/open.png" alt=""></button>
        ...
        <div class="product-info">
            ...
            <span class="price">$${data.sellPrice}</span><span class="actual-price">$${data.actPrice}</span>
        </div>
    </div>
    `;
}
